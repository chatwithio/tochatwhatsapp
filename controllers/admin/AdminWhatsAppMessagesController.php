...
class AdminWhatsAppMessagesController extends ModuleAdminController
{
    ...
    public function initContent()
    {
        ...
        $this->setTemplate('../../../../modules/tochat_whatsapp/views/templates/message_list.tpl');
    }
    ...
    public function getMessagesList(){
        ...
        $messages = $this->paginate_content( $messages, $page, $pagination );

        return ($helper->generateList($messages, $this->fields_list));
    }

    public function paginate_content( $content, $page = 1, $pagination = 20 ) {
